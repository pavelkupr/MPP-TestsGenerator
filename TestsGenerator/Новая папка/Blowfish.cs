...
namespace FilePickerTest.Cryptography
{
    /// <summary>
    ...
    public class Blowfish
    {
        ...
        /// </summary>
        /// <param name="source">The array to encrypt.</param>
        /// <param name="length">The amount to encrypt.</param>
        public void Encipher(byte[] source, int length)
        {
            int newLength;
            byte[] data;
            byte[] remain;
        ...
        /// </summary>
        /// <param name="source">The array to decrypt.</param>
        /// <param name="length">The amount to decrypt.</param>
        public void Decipher(byte[] source, int length)
        {
            int newLength;
            byte[] data;
            byte[] remain;
